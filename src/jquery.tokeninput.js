...
$.TokenList = function (input, url_or_data, settings) {
    ...
    function addCurrentTokenInputValue() {
      var inputName =   $("#" + settings.idPrefix + input.id).val();
      if($.trim(inputName)=="") return false;
      
      var inputID = undefined;
      var parseFunction = typeof(settings.parseCustomEntryID) == "string"
        ? eval("(" + settings.parseCustomEntryID + ")")
        : settings.parseCustomEntryID
        ;
      if(typeof(parseFunction) == "function"){
        inputID = parseFunction(inputName);
      }
      var currentTokenInputItem = {"name": inputName, "id": inputID};
